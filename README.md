...
A React frontend built to test and demonstrate the [multi-tenant SaaS backend](https://github.com/milk-in-a-bag/multi-tenant-saas-backend). The backend is hosted separately, and this UI exists purely to exercise its API endpoints and verify they work correctly.
